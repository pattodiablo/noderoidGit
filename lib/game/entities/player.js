	...
	EntityPlayer = ig.Entity.extend({
		...
		moveLeft:function(){
				...
				this.flip = false	;
					if(ig.input.pressed('left')){
						socket.emit('moveLeft',this.netName);	
						this.flag=true;		
					}
		},
		...
		moveRight:function(){
				...
				if(ig.input.pressed('right')){
					socket.emit('moveRight',this.netName);
					this.flag=true;			
					}
		},
		...
		notMoved:function(){
				...
				if(this.flag==true){
				socket.emit('notMoved',this.netName);	
				this.flag=false;
				}
		},
	...
	// jump
			...
			if( this.vel.x != 0 ) {
				...
				socket.emit('playerMove',this.pos.x,this.pos.y,this.netName,"default",this.flip);
